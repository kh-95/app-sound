...
$(function () {
	...
	$('#app-side-mini-toggler').on('click', function () {
		...
		$("#app-side-mini-toggler i").toggleClass('icon-chevron-left icon-chevron-right');
	});
	...
	$('#onoffcanvas-nav').on('click', function () {
		...
		$("#onoffcanvas-nav i").toggleClass('icon-chevron-left icon-chevron-right');
	});	
	
	$('.onoffcanvas-toggler').on('click', function () {
		$(".onoffcanvas-toggler i").toggleClass('icon-chevron-left icon-chevron-right');
	});
});
